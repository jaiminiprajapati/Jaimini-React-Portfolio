...
import jaimini from "../../assets/jaimini.png";
      ...
      >
        <div className={style.left_side}>
          ...
          >
            <a
              ...
              target="_blank"
              href="https://docs.google.com/document/d/1NOPE9njEgZtrKJh2M_bFiIJZm3Q0OmlX3_PtXBnq0So/edit?usp=sharing"
            >
        ...
        >
          <div className={style.img_section}>
            <img src={jaimini} alt="Jaimini" className={style.hero_image} />
          </div>
        </motion.div>
      </motion.div>
    </div>
